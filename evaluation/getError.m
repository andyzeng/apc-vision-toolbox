...
% 
% Check error of 'predictions.mat' file generated from runEval.m
%
% ---------------------------------------------------------
...
predictedPosesFile = 'predictions.mat';
groundTruthPosesFile = fullfile(benchmarkPath,'labels.mat');
...
groundTruthPoses = tmpFile.labels;
